...
| `neutral-50` | `#f6f7f1` | 页面和导航背景 |
| `neutral-25` | `#fbfcf8` | 卡片、弹窗和底部导航背景 |
| `white` | `#ffffff` | 反色文字和打印白色 |

主操作和选中状态使用纯黑 `#000000`。这三项构成全局基础配色：页面 `#f6f7f1`、表面 `#fbfcf8`、主操作 `#000000`。
