...
“本周菜单”复用已有菜品和店铺，可以按日、周、月、年安排早餐、午餐、下午茶和晚餐。每餐默认三个可增减档位；日视图支持保留锁定项后随机菜单。菜单选择复用“我的菜单”速览结构，并提供全菜单搜索、常吃清单和菜篮子。排行榜按周、月、年统计截至当天的记录：在家菜品按菜品统计，外食店内菜品统一归入所属店铺，同一餐同一家店只计一次。
